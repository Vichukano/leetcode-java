...
/**
 * NumberOGiven two integer arrays startTime and endTime and given an integer
 * queryTime.
 ...
 * queryTime.fStudentsDoingHomewokrAtGivenTime
 */
public class NumberOfStudentsDoingHomewokrAtGivenTime {
